...
class RegisterUnityScreen extends StatefulWidget {
  @override
  _RegisterUnityScreenState createState() => _RegisterUnityScreenState();
}

class _RegisterUnityScreenState extends State<RegisterUnityScreen> {
  ...
  Widget conteudo(context) {
    var _listPermissao = ['Permissão', 'Administrador', 'Gerente'];
    return Row(
      children: <Widget>[
        Expanded(
            flex: 6,
            child: Form(
              ...
              children: <Widget>[
                ...
                Helpers.campoTextoInterno(
                    'Email', Color.fromRGBO(220, 220, 220, 1), false),
                    Helpers.campoTextoInterno(
                    'Senha', Color.fromRGBO(220, 220, 220, 1), false),
                dropdown(
                          'Permissão', Color.fromRGBO(220, 220, 220, 1), _listPermissao),
              ],
            ),
            )),
       SizedBox(width: 70,),
          ...
          children: <Widget>[
            Expanded(
              ...
              child: button(context, 'Cadastrar', Colors.white,
                  Color.fromRGBO(254, 193, 24, 1), UsersScreen()),
            ),
            Expanded(
              flex: 7,
              child: Text(''),
